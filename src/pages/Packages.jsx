...
export default function Packages() {
  ...
  return (
    <div style={{minHeight:'100vh',background:C.dark,fontFamily:"'DM Sans',sans-serif"}}>
      ...
      {/* HERO */}
      <section style={{position:'relative',height:'45vh',minHeight:'460px',overflow:'hidden',display:'flex',alignItems:'center',justifyContent:'center'}}>
        ...
        <div style={{position:'relative',zIndex:10,textAlign:'center',padding:'140px 24px 0'}}>
          ...
          <h1 style={{fontFamily:"'Playfair Display',serif",fontSize:'clamp(32px,5vw,56px)',lineHeight:1.1,color:'#ffffff',animation:'fadeUp 0.8s ease 0.4s both'}}>
      ...
      <main style={{padding:'72px 48px',maxWidth:'1100px',margin:'0 auto'}}>
        ...
        <Reveal>
          <div style={{textAlign:'center',marginBottom:'36px',padding:'18px',background:'rgba(218,145,0,0.06)',border:'0.5px solid rgba(218,145,0,0.25)',borderRadius:'10px'}}>
            ...
            <p style={{fontSize:'12px',color:'rgba(255,255,255,0.75)',marginTop:'5px'}}>Book a complimentary first shoot to see the quality before you commit.</p>
          </div>
        </Reveal>
              ...
              <Reveal key={pkg.name} delay={i*0.08}>
                <div style={{background:pkg.hot?'rgba(218,145,0,0.07)':'rgba(255,255,255,0.03)',border:`0.5px solid ${pkg.hot?'rgba(218,145,0,0.4)':'rgba(227,218,201,0.08)'}`,borderTop:`2px solid ${pkg.accent}`,borderRadius:'14px',padding:'28px 24px',display:'flex',flexDirection:'column',height:'100%',boxShadow:pkg.hot?'0 0 40px rgba(218,145,0,0.08)':'none'}}>
                  <div style={{marginBottom:'18px'}}>
                    ...
                    <p style={{fontFamily:"'Playfair Display',serif",fontSize:'24px',color:'#ffffff',marginBottom:'5px'}}>{pkg.name}</p>
                    <p style={{fontFamily:"'Playfair Display',serif",fontSize:'32px',color:'#ffffff'}}>{pkg.price}</p>
                  </div>
                  ...
                  <div style={{borderTop:'0.5px solid rgba(227,218,201,0.08)',paddingTop:'12px'}}>
                    <p style={{fontSize:'10px',color:'rgba(218,145,0,0.85)',letterSpacing:'0.04em'}}>Ideal for: {pkg.ideal}</p>
                  </div>
                </div>
              </Reveal>
            ))}
        ...
        <Reveal>
          <div style={{background:'rgba(218,145,0,0.05)',border:'0.5px solid rgba(218,145,0,0.15)',borderRadius:'16px',padding:'48px',marginBottom:'72px',backgroundImage:gridBg,backgroundSize:'40px 40px'}}>
            <p style={{fontSize:'10px',letterSpacing:'0.16em',textTransform:'uppercase',color:'rgba(218,145,0,0.85)',marginBottom:'14px',textAlign:'center'}}>Build your shoot</p>
            <h2 style={{fontFamily:"'Playfair Display',serif",fontSize:'32px',color:'#ffffff',marginBottom:'36px',textAlign:'center'}}>Get an instant quote.</h2>

            <p style={{fontSize:'11px',textTransform:'uppercase',letterSpacing:'0.1em',color:'rgba(218,145,0,0.85)',marginBottom:'12px'}}>1. Choose your base package</p>
            ...
            <p style={{fontSize:'11px',textTransform:'uppercase',letterSpacing:'0.1em',color:'rgba(218,145,0,0.85)',marginBottom:'12px'}}>2. Add extras (optional)</p>
            ...
            <div style={{borderTop:'0.5px solid rgba(218,145,0,0.2)',paddingTop:'24px',display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:'16px'}}>
              <div>
                <p style={{fontSize:'11px',color:'rgba(218,145,0,0.85)',marginBottom:'4px',letterSpacing:'0.08em',textTransform:'uppercase'}}>Your estimate</p>
        ...
        {/* Add-ons grid */}
        <Reveal>
          <h2 style={{fontFamily:"'Playfair Display',serif",fontSize:'28px',color:'#ffffff',marginBottom:'24px'}}>Add-ons</h2>
